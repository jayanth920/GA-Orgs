...
<details>
  ...
  A method is a function that is defined on an object or class (more about these later - not to be confused with the <code>.class</code> used in CSS). Methods begin with a <code>.</code>, since they are object-properties. For example, <code>.push()</code> and <code>.reverse()</code> are methods, specifically <code>Array</code> methods.
</details>
