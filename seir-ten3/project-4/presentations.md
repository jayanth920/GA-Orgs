...
**If working in a group, each member of the group** must participate in the presentation.
...
Five minutes will then be allotted for questions from the class. We suggest the following structure:

## Introduction

- What's your app called?
- Groups: Who are your group members? Who had which responsibilities?
...
- What
  [Git Workflow](../../../git-workflow-teams)
  did you follow?
