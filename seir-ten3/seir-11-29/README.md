...
# Welcome to General Assembly SEIR-11/29 - You Amazing Folks!
...
- Course duration: Monday, November 29th, 2021 - Wednesday, March 2th, 2022 (60 days - not including holidays)
- Holidays:
	12/24/2021
	12/25/2021
	12/27/2021
...
|Co-Lead| Arthur D'Amato|  @Arthur D'Amato  |  |
...
For your convenience, recordings of the lessons will be available to review at 
 [YouTube](https://www.youtube.com/watch?v=e9CasWfl2d4&list=PL51l5r1uFLPM8uWWL8V2i061FiroIqV08).
 
 
### SEI Remote OFFICE HOURS
- Monday - Thursday: 4-7 PM Pacific TBD
- Sunday: 1-6 PM Pacific
- Hosted by @Michael Merlo and @doug.leinen!
...
[Link to submit Deliverables](https://docs.google.com/forms/d/e/1FAIpQLSeAyMKtawtX_0J_lRePhXxPlyKc284Qkr9LDebMSB6Juua6_A/viewform?usp=sf_link)
...
2. In another tab, browse to the GA class repo:  [https://git.generalassemb.ly/SEI-CC/seir-11-29/](https://git.generalassemb.ly/SEI-CC/seir-11-29/)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/SEI-CC/SEI-11-29
```

You can now `$ cd SEI-WEST-COAST-8-30` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/SEI-CC/SEI-11-29.git
```
