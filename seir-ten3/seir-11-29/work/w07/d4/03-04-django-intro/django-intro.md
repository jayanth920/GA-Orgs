...
We'll get started working on the tutorial together.  However, after creating the sample application and getting connected to a database, it will be up to you to complete the tutorial through at least Part 4 (do as much as possible).
