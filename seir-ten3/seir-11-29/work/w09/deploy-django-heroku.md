...
If you have pyscopg2 *ERRORS* instead lets install the binary version of the package 

```pip3 install django-on-heroku```

Then in settings.py, at the very bottom
...
```
$ heroku config:set AWS_ACCESS_KEY_ID=whateveryourkeyisnormalcase
```
