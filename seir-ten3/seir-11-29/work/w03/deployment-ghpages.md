...
Although not necessary, go ahead and push the latest commit to _origin_:<br>`git push origin master` or `main`, check your branch using `git branch` in the terminal
