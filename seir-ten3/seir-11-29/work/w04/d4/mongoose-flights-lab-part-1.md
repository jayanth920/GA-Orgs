...
### Yes, the final version of `mongoose-flights` (parts 1 thru 3 combined) will be a deliverable, so do each part and don't fall behind.

Please create a repo on your **personal** GH account named `mongoose-flights` and commit your code.
