...
2. Clone the repo:  `git clone https://git.generalassemb.ly/SEI-CC/express-todos-code-along-app.git`
3. Move into the newly created repo/project folder:  `cd express-todos-code-along`
