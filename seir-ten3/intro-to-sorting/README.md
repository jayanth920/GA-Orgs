...
1. Fork this repo to your own account and download to your `sei/exercises` folder.
1. Follow along the steps in this README to progress through the myGA modules.
1. Do not work on the CodePen/JavaScript implementation of Bubble Sort yet. We will work on that together.
1. When you are finished, submit your work with a pull request on this repo.
1. When submitting your PR, summarize your learning on this topic.
...
1. [myGA module: Intro to Sorting Algorithms](https://my.generalassemb.ly/activities/818) -- Start here... 
1. [myGA module: Basic Sorting Algorithms](https://my.generalassemb.ly/activities/778) -- ... continue your studies here
2. [Exercise: Try to Write a Bubble Sort Algorithm](./bubblesort.js) -- this afternoon's coding exercise
