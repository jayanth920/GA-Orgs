...
- [Project Proposals](../../../project-3/issues/new?assignees=&labels=&template=project-proposal-submission.md&title=Your+Group+Names+%2B+Squad+Lead) are due on **Wednesday, 12/7 at or before 2:30 PM ET**.
- Project Deliverable is due on or before **Wednesday, 12/14 at or before 12:30 PM ET**.
- Presentations will be on **Wednesday, 12/14 at 1:30 PM ET** to the entire cohort.
...
- Your back-end/API must be deployed to Heroku and your front-end must be deployed to
  GitHub pages or [Netlify](../../../netlify-deploy-react), [Vercel](https://vercel.com/guides/deploying-react-with-vercel), [Surge](https://daveceddia.com/deploy-create-react-app-surge/). Applications that are not deployed will be considered
  incomplete.
...
You should only attempt these bonuses _if and only if_ you've satisfied the base
...
**_DO NOT FORK THIS REPOSITORY!_** Create a **new** organization and two repositories. Your project is due on the date specified in your course schedule. Create an issue ticket on this project-3 repo containing and submit your project details on this [spreadsheet](https://docs.google.com/spreadsheets/d/1SejSxctsrMX53L8JKqtMsvDGlhE7CCRoTqX__oI40rY/edit?usp=sharing):
...
Your project is due on the date specified in your course schedule. Create an issue ticket on this project-3 repo containing and submit your project details on this [spreadsheet](https://docs.google.com/spreadsheets/d/1SejSxctsrMX53L8JKqtMsvDGlhE7CCRoTqX__oI40rY/edit?usp=sharing):
