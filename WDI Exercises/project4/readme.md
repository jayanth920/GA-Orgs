# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Project #4 Project: Your Portfolio Project
...
* **Be a complete product.** For an app, that most likely means multiple models,
  relationships and CRUD functionality for at least a couple of those models.
* **Implement thoughtful user stories** that are significant enough to help you
  know which features to build and which to scrap
...
[github.com/ga-dc/project4-gallery](https://github.com/ga-dc/project4-gallery/issues/new?body=Link%20to%20repo%3A%0ALink%20to%20deployed%20app%3A%0A%0AThings%20you%27d%20like%20specific%20feedback%20on%3A%0A%0A)
...
course calendar). Create an issue on [the project4-gallery
repository](https://github.com/ga-dc/project4-gallery) containing:

* A link to your deployed project
* A link to your Project 4 Github repository/repositories (Do not fork this
  repo)
...
Support will be provided exclusively through issues submitted to this repo. This
is to mirror "in-the-wild" practices. Developers often interact with (and
receive help from) each other via GitHub issues.
