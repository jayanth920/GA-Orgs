...
#### TDD: Test-driven development - James
...
#### BDD: Behavior-driven development - Ali
...
## Mocha, Chai And Javascript Testing - Intro (10 min) - James
...
```bash
git clone git@git.generalassemb.ly:ga-wdi-exercises/testing-candies-express.git
npm install
node app.js
```
...
## Independent Practice (20 minutes) - Ali
