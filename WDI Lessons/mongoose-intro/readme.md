...
<details>
  ...
  * Documents are the NoSQL equivalent of a table row.
  ...
  > This is not the only way that a NoSQL database organizes data. Start [here](http://opensourceforu.com/2017/05/different-types-nosql-databases/) to learn more.
...
<details>
  ...
  * Technically, it's BSON -- "binary JSON."
