...
## The Component Lifecycle (10 min / 0:20) - James
...
## We do: Exploring the Lifecycle methods (20 min / 0:40) - Ali
...
### An Aside: Axios (10 min / 0:50) - James
...
The app we're going to build will pull characters from an [Express API](https://ga-flashcards.herokuapp.com/api/words) and create a flashcard for each person. The app will then cycle through each word, giving the user 10 seconds to think of the definition before moving on to the next card.

### We Do: Adding the Flashcard Container - James

#### Use Axios to query the  API
...
#### Add an event listener to switch between cards - Ali
...
### You Do: Adding a Timer to the Flashcard - James
...
#### We Do: Adding the Definition Component - Ali
...
## You Do: Show or Hide the Definition - James
