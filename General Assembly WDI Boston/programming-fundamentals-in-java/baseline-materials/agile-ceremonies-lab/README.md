...
- Review the basics of Agile methodologies and why they are used
...
## Important agile practices as they relate to SECA (25 mins)
...
In groups of three or four, make a wireframe for a new restaurant's home page using the whiteboard walls.

## User Stories (15 mins)
...
When we practice **TDD** we will be able to write integration (user acceptance) tests that will match our user stories. This is really cool. If done correctly, our tests will automatically check to see that all of our functionalities (pathways) are available and working. 


## Create User Stories - Independent Practice (5 mins)

Individually, create four user stories that apply to the functionality of your favorite app or website, following the format above.
...
- Compare agile development and waterfall development.
- What are user personas and why are they used?
