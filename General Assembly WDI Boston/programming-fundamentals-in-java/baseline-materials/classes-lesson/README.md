...
| TIMING  | TYPE  | TOPIC  |
|:-:|---|---|
| 5 min  | [Opening](#opening-what-are-classes-5-minutes)  | Discuss lesson objectives |
| 25 min  | [Introduction](#introduction-what-are-classes-25-minutes)  | What are classes? |
| 10 min  | [Demo](#demo-what-are-classes-10-minutes)  | What are classes? |
| 10 min  | [Guided Practice](#guided-practice-what-are-classes-10-minutes)  | What are classes? |
...
This has an advantage for whomever is implementing the object as well. They can change the internals, perhaps make it more efficient, without breaking compatibility with any code that uses it already. This process of hiding the internals is called __encapsulation__.
...
Throughout much of our work so far in this course, we have seen classes being used, and object being instantiated without understanding the reason behind all of it. In our next lesson, we will be discussing the `extends` keyword you have seen at the top of every Activity, a concept known as subclassing.
