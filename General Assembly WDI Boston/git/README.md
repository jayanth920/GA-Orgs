...
3. Open the file with VS Code and copy in the following lines:
...
5. Inside of the `<your-name>s-game-of-gits` directory type `git status`. Did anything
   happen?
...
## Code Along: Staging and Committing
...
main branch (typically called `main`).
...
1. Switch back to your `main` branch. (Notice anything?) Add what really
   happened to Ned.
