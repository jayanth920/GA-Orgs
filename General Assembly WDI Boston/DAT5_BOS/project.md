...
### Week 5: Data Exploration and Analysis Plan
...
### Week 6: Deadline for Topic Changes
...
### Week 10: Second Draft Due (Optional)
...
Deliver your project presentation in class, and submit all required deliverables (paper, slides, code, data, and data dictionary). There would be some studetns who would choose to work on data related to the company. Such students can be exempt from making a presentation if their company wishes that the presentation will affect their legal terms. If you indeed do choose to work on such a project then make sure the legal team, manager of your organization or company is aware of the fact that the Instructor, Expert-In Residence and GA team can look at your data and work as well.

## GitHub Pages
Those who wish to make a final presentation and if their data can be public then they should post their final results on their github pages. 

* Here are instructions: https://pages.github.com