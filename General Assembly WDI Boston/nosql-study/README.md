...
- Describe what a database is and why they are used.
- List the strengths and weaknesses of NoSQL databases.
- List criteria that can help someone choose between SQL and NoSQL databases.
