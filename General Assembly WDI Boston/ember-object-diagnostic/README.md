...
1. Follow the directions given in [diagnostic.js](./app/diagnostic.js).
1. All diagnostic responses are to be made in [diagnostic.js](./app/diagnostic.js).
...
You can test your code by serving the app with `ember serve` and using the
Chrome console.
