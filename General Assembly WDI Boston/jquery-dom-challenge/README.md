...
jQuery is our new best friend - who wouldn't love a library of methods we get
to use to speed up our front-end development?

In this practice, you'll focus on creating a mini application using jQuery
...
- Use jQuery to build an interactive application
...
2. Run the server with `grunt serve`
