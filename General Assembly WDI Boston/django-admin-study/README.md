...
The Django framework includes a complete CMS (content management system)
for any models we register. This tool allows us to CRUD on our data without
the need for any views, urls, or clients. Let's take a look at how we can
use this Django feature.
...
- Create a new super user using Django
- Register models with the admin app
- CRUD on data through the admin CMS
