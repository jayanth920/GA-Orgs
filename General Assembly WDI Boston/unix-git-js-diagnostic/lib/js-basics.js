...
GOAL: Using the list from above of the primitive data type and using the list from
...
// 1c) This primitive data type is automatically assigned to a variable that has
// just been declared.
...
// 1e) This primitive data type represents a nonexistent element.
...
/* =============== QUESTION #5 ==================
  Navigate to bin/js-basics-continued.js to complete question 5!
*/
