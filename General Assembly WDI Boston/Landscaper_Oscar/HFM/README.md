...
1) Create a javascript file inside this folder to record your answers (maybe name it `answers.js`)
...
- Do the following and console.log the final results (there are some *thought* questions, you don't have to write out an answer for those marked as such):
...
Note: if you have to add to the array, feel free to add any movie you'd like
 ...
 1. `slice` the last half of the array (challenge yourself and try to programmatically determine the middle of the array  rather than counting it and hard coding it) - Thought question: did this permanently alter our array?
...
Revisit this weeks labs to complete something left finished.
