...
## CSS/HTML Layout - Oscar - Required

Complete [this CSS/HTML layout assignment](oscar)
...
1. Practice [Arrays, Loops, and Conditionals](HFM/README.md)
1. Add the ability to reset the Landscaper game at any point so that you can play again
