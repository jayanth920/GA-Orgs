# ![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png) Modeling Tunr - SQL
...
* Look at `db/dbSetup.js`. Get a basic idea for what it is doing, then run it with `node db/dbSetup.js`.
* Start your server using `node server.js`


* Navigate to `tunr-client` and follow the instructions there as well.
