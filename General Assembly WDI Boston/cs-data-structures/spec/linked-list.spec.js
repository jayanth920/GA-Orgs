...
describe('LinkedList', function () {
  ...
  describe('removeFirst', function () {
    describe('when the list is empty', function () {
      ...
      const firstValue = list.removeFirst()

      it('returns undefined', function () {
        expect(firstValue).to.eq(undefined)
      })
    })

    describe('when the list has one value', function () {
      const list = new LinkedList()
      list.prepend('🌮')
      ...
      it('removes the correct value from the head', function () {
        expect(firstValue).to.eq('🌮')
      })

      it('the former head is now undefined', function () {
        expect(list.head).to.eq(undefined)
      })

      it('the former tail is now undefined', function () {
        expect(list.tail).to.eq(undefined)
      })
    })

    describe('when the list has more than one value', function () {
      const list = new LinkedList()
      list.prepend('🌮')
      list.prepend('🍔')

      // this should be hamburger
      const firstValue = list.removeFirst()
      ...
      it('the new head is now the second value in the list', function () {
        expect(list.head).to.be.an.instanceOf(Node)
        expect(list.head.value).to.eq('🌮')
      })

      it('the tail is still the last value in the list', function () {
        expect(list.tail).to.be.an.instanceOf(Node)
        expect(list.tail.value).to.eq('🌮')
      })
    })
  ...
  describe('remove', function () {
    ...
    describe('when the list has one element and it matches', function () {
      ...
      it('the head is undefined', function () {
        expect(list.head).to.eq(undefined)
      })

      it('the tail is undefined', function () {
        expect(list.tail).to.eq(undefined)
      })
    })
