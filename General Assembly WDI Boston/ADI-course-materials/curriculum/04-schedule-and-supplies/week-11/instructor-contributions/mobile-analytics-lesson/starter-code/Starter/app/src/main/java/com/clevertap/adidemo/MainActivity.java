...
public class MainActivity extends AppCompatActivity  {
    ...
    private void setUpViews(){
        ...
        // if we have stored a last-viewed category sort the product data to show that category first
        String lastViewedCategory = (clevertap != null) ? clevertap.profile.getProperty("lastCategoryViewed") : null;
        data = createProductData(lastViewedCategory);

        RecyclerView.Adapter adapter = new DataAdapter(context, data);
        recyclerView.setAdapter(adapter);

        // if approprate, restore the saved scroll state of the product list
