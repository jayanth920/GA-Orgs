...
Developing any type of application requires a degree of comfort navigating and interacting with your operating system through the command line. Similar to how you'll practice writing and running Java files and Android apps later in the course, in this lesson ,we'll create, modify and move files and folders the terminal to get some practice with Unix commands.
