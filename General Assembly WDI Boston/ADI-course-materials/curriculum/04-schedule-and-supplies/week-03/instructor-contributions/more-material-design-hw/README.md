...
When looking for a job, having a good web presence is important. There are many ways to improve your web presence: LinkedIn, GitHub, etc. Today, we are going to try Medium.
...
Once you've created an account, read the following for further instructions on the homework:
...
The only requirement is that the article is at least 150 words long (not counting snippets of code).

**Also, you cannot write about the same topic you wrote about in Medium Article 1 (last night's HW)!**
