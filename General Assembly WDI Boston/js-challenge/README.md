...
These are optional challenges for practicing javascript.  
You should complete them in order since they build upon each other.
...
- Use the javascript language to solve problems
