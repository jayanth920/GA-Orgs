...
1. Navigate to: https://git.generalassemb.ly/seir-826/git-and-github
...
1. On Github, if it hasn't already taken you to your copy, navigate to your forked version of this repo (your username should be in the top left corner of the page followed by a slash and the name of the repo. Ex: `kchia/git-and-github`).

#### Fork (your copy):

![forked repo](https://i.imgur.com/RMoWxcf.png)

#### Original (instructor copy):

![original repo](https://i.imgur.com/nEZNcoq.png)
...
1. Click on the `clone or download` button on YOUR Class fork:
    ...
    ![clone or download](https://i.imgur.com/0tKcE2f.png)
...
1. Make a clone using terminal: `git clone https://git.generalassemb.ly/seir-826/git-and-github.git`
...
![fork remote](https://i.imgur.com/stQxlOj.png)

1. Add the instructor repo so  you can get our changes/updates. Navigate to the instructor copy: https://git.generalassemb.ly/seir-826/git-and-github
...
![Add upstream](https://i.imgur.com/S8eLVqR.png)
...
![git remote -v](https://imgur.com/fKFOW8E.png)

Again, origin should be associated with YOUR copy. YOUR username should be part of this URL

And, upstream should be associated with the instructor copy. There should be `seir-826` as part of the URL

## Step 4 - Edit Locally

1. `cd` inside the `git-and-github` repo.

1. Create a new file called `example.js` in the root with `touch example.js`. 

1. Open `example.js` with your text editor
...
5. In your terminal / Git Bash, run the command `git push origin master` to push your work from your local machine to your repository on Github.
   ...
   ![push](https://i.imgur.com/IoaEW3S.png)
...
I am going to make a change in today's repo. Then you'll pull the changes down to your local copy, then you should be able to push it to your fork on github.

Follow [these instructions](https://help.github.com/en/articles/syncing-a-fork)
