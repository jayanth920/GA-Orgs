# BONUS HOMEWORK: Fake Resume & Github Practice
...
- This BONUS homework does NOT have to be submitted. That said, we strongly encourage you to go to office hours to get feedback on your code from the office hours instructor!

## Git & Github - Getting Started

![](https://s-media-cache-ak0.pinimg.com/originals/2d/8e/e8/2d8ee815146390d567706f2c7b5c2916.gif)

1. Create a `homework_day2` repo for tonight's homework.
1. Create a file called `answers.md` inside of the homework folder.
...
1. If completing the bonus section, include a `loops.js` file inside of the homework folder.

## Hungry for More?
## Bonus JavaScript (Optional)
