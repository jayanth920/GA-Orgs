...
1. Link it to an `index.html` file so that you can see your code output in the developer console.
...
[Move on this next lab](https://git.generalassemb.ly/seir-622/control-flow-lab)
