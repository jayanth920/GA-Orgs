...
describe('Contact component:', () => {
	...
	it('has a name input', () => {
		const component = shallow(<NewContact />);
		expect(component.find("input[id='name']").exists()).toBe(true);
	});

	it('has an email input', () => {
		const component = shallow(<NewContact />);
		expect(component.find("input[id='email']").exists()).toBe(true);
	});

	it('has an image input', () => {
		const component = shallow(<NewContact />);
		expect(component.find("input[id='image']").exists()).toBe(true);
	});
});
