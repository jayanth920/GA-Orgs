...
Go test signing up in Postman!!! Use a POST request that has a body containing an JSON object with an email and password. You should now see a response that looks like:
